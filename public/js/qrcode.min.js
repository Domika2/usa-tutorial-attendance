/**
 * EasyQRCodeJS / QRCode.js standalone generator
 * Generates crisp QR codes on canvas / SVG without external dependencies
 */
var QRCode;
(function(){
    ...
    QRCode.prototype.makeCode = function(text){
        if(!text) return;
        var qrcode = new QRCodeModel(-1, this.options.correctLevel);
        qrcode.addData(text);
        qrcode.make();
        ...
        var tileW = this.options.width / moduleCount;
        var tileH = this.options.height / moduleCount;
